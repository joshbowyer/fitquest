...
export const EXERCISE_BODY_PART_TAGS: Record<string, string[]> = {
  ...
  hammer_curl: ['biceps', 'forearm', 'grip', 'pull'],
  face_pull: ['back', 'pull'],
  wrist_curl: ['forearm', 'grip'],
  reverse_curl: ['forearm', 'biceps', 'grip', 'pull'],
  farmer_carry: ['forearm', 'grip', 'core'],
  farmers_walk: ['forearm', 'grip', 'core'],
  dead_hang: ['forearm', 'grip', 'back', 'bodyweight'],
  plate_pinch: ['forearm', 'grip'],
